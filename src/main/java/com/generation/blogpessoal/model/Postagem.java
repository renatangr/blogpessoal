...
public class Postagem {
	...
	@Column(length = 100)
	@NotBlank(message = "Insira um título. Espaço em branco não é aceito.") // Para Strings -> Não aceita um espaço em branco: " ";
	@Size(min = 5, max = 100, message = "O título deve ter no mínimo 5 e no máximo 100 caracteres.")
	private String titulo;
	
	@Column(length = 1000)
	@NotBlank(message = "O texto é obrigatório!") // Para Strings -> Não aceita um espaço em branco: " ";
